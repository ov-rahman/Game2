...
export const FLOORS = [
  {
    ...
    pits: false,
    wideCorridors: 0.35,
    // What runs out of the walls here. Every floor has one.
    liquid: { color: [0.55, 0.95, 0.45], name: 'сок' },
    relief: 0.62,
    scatter: 1.15,
...

  {
    ...
    pits: true,
    wideCorridors: 0.22,
    liquid: { color: [0.45, 0.85, 1.0], name: 'вода' },
    relief: 0.78,
    scatter: 1.0,
    special: { treasure: 1, shop: 1, challenge: 1 },
...

  {
    ...
    pits: true,
    wideCorridors: 0.3,
    liquid: { color: [1.0, 0.62, 0.22], name: 'шлак' },
    relief: 0.5,
    scatter: 0.85,
    special: { treasure: 1, shop: 1, challenge: 1 },
...

  {
    ...
    pits: false,
    wideCorridors: 0.4,
    liquid: { color: [1.0, 0.4, 0.12], name: 'лава' },
    relief: 0.42,
    scatter: 0.7,
    special: { treasure: 1, shop: 1, challenge: 1 },
...

  {
    ...
    pits: true,
    wideCorridors: 0.5,
    liquid: { color: [0.85, 0.45, 1.0], name: 'кислота' },
    relief: 0.9,
    scatter: 1.2,
